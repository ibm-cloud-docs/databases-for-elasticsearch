...
- Scaling your deployment up might cause your RabbitMQ to restart. If your deployment needs to be moved to a host with more capacity, then the RabbitMQ is restarted as part of the move.
