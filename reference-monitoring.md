...
From the Sysdig _Dashboards_ sidebar, your {{site.data.keyword.databases-for-elasticsearch}} dashboards are under _IBM_. 
...
| [IO utilization in percent 15 minute average](#ibm_databases_for_elasticsearch_disk_io_utilization_percent_average_15m) | 
| [IO utilization in percent 30 minute average](#ibm_databases_for_elasticsearch_disk_io_utilization_percent_average_30m) | 
| [IO utilization in percent 5 minute average](#ibm_databases_for_elasticsearch_disk_io_utilization_percent_average_5m) | 
| [IO utilization in percent 60 minute average](#ibm_databases_for_elasticsearch_disk_io_utilization_percent_average_60m) | 
| [IOPS read & write total count for an instance](#ibm_databases_for_elasticsearch_disk_iops_read_write_total) | 
| [Max allowed memory for an instance](#ibm_databases_for_elasticsearch_memory_limit_bytes) | 
| [Number of unassigned shards](#ibm_databases_for_elasticsearch_unassigned_shards_total) | 
